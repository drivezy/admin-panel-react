            ...
            <div className="listing-pagination">
...

                {
                    ...
                    <div className="pagination-record">
                        Showing {current_page ? ((((current_page) * limit) - limit) + 1) : 0} - {current_page ? ((((current_page*limit)<statsData.total) ? (current_page*limit) : statsData.total )) : 0} results from {statsData ? statsData.total : 0}
                    </div>
                }
            </div>
        )
