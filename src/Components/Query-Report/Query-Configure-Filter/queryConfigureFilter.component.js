...
export default class ConfigureDynamicFilter extends Component {
    ...
    assignSelectedFilterColumn = ({ single }) => {
        ...
        if (single) {
            ...
            filterArr[arrayIndex][0].column = SelectFromOptions(dictionary, single, 'path');
    ...
    initialize() {
        ...
        if (this.urlParams.order) {
            this.state.order = SelectFromOptions(dictionary, this.urlParams.order, "name");
        }
    ...
    render() {
        ...
        const { dictionary, layout , history } = this.props;
                            ...
                            <div className="footer-group order-content">
                                ...
                                <div className="filter-box">
                                    <SelectBox
                                        ...
                                        value={order} field='name' options={dictionary} placeholder='Order'
                                    />
                                </div>
                            </div>
